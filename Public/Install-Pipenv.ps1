function Install-Pipenv {
  ...
  process {
    ...
    switch ([venv]::data.Os) {
      'Windows' { Write-Console "Pyenv does not officially support Windows and does not work in Windows outside the Windows Subsystem for Linux." -f LightCoral; break }
